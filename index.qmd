...
::: notes
-   Enhance accessibility and inclusivity of videos by adding automatically generated subtitles. Still evaluating tool for crowdsourcing ([ClassTranscribe](https://classtranscribe.illinois.edu/){target="_blank"}) subtitles.
...
::: notes
-   Use new web technologies to run code in browser. Another avenue to increase accessibility and interactive learning from day one.
-   Also uses web technologies making the content screen reader compatible.
-   Semantic HTML focuses on the meaning of the content, increasing the meaning of the styling. Styling can easily be changed globally for entire set of slides.
:::
...
<a href="https://skng.de/udl/slides">{{< iconify fa6-solid window-maximize >}} skng.de/udl/slides</a>
:::
